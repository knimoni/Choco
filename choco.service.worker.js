...
const CACHE_NAME = "choco-cache";
const OFFLINE_URL = "choco.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["choco.html","choco.js","choco.wasm","choco.pck","choco.offline.html","choco.icon.png","choco.apple-touch-icon.png"];
